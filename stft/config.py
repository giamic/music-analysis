...
STORAGE_FOLDER = os.path.join(os.path.abspath(os.sep), 'media', 'giamic', 'Local Disk', 'Pycharm Projects',
                              'music_analysis')
# SPOTIFY_DATA_FOLDER = os.path.join(STORAGE_FOLDER, 'data', 'spotify_previews')
SPOTIFY_DATA_FOLDER = os.path.join(DATA_FOLDER, 'spotify_previews')
...
try:
    PARAMS['n_train_examples'] = len(os.listdir(os.path.join(SPOTIFY_DATA_FOLDER, 'images', 'train')))
    PARAMS['n_validation_examples'] = len(os.listdir(os.path.join(SPOTIFY_DATA_FOLDER, 'images', 'validation')))
    ...
    PARAMS['steps_validation'] = int(PARAMS['n_validation_examples'] / PARAMS['bs'])
    PARAMS['steps_train'] = int(PARAMS['n_train_examples'] / PARAMS['bs'])
